...
function run_devels_playground {
    ...
    try {
        ...
        Write-Host "`r`nNOTE: $software_name is required to be running for the Devel's Playground to work.`r`nDo NOT quit $software_name until you are done running it.`r`n" 
