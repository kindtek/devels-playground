...
## Set up any Windows 10+ environment with Github, VSCode, Docker Desktop, Windows Terminal (with upgraded Powershell), WinGet, and more. Take a fresh (or not) Windows environment and install a suite of dev toolswith only a few keystrokes. More updates coming soon including macOS support.
&nbsp;
