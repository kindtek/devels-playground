...
sudo cp /home/dvl/dvl-works/dvl-playg/kernel/6_27/amd/.config_0 .config && \
...
sudo mkdir -p ../../../${_AGL}/kernels/6_27/amd && sudo cp -f arch/x86/boot/bzImage ../../../${_AGL}/kernels/6_27_0/amd/linux-6_27_0$kernel_tag && \
sudo mkdir -p ../../../dvl/kernels/6_27/amd && sudo cp -f arch/x86/boot/bzImage ../../../dvl/dvl-works/dvl-playg/kernel/6_27/amd/linux-6_27_0 && \
