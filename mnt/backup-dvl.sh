...
sudo cp -arf dwork/mnt/backup-dvl.sh ${backup_mnt_location}/${_GBL}/backup-dvl.sh && cp -arf dwork/mnt/backup-dvl.sh /home/${_GBL}/backup-dvl.sh  && \
...
cp -arf --backup=$VERSION_CONTROL --update /home/dvl $HEL_DESTINATION
...
cp --backup=$VERSION_CONTROL --remove-destination -arf $_NIX_MNT_LOCATION/gbl/dvl-$WSL_DISTRO_NAME/dvl /home" > $HEL_RESTORE_SCRIPT
